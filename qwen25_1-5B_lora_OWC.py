...
# 处理数据集
train_jsonl_path = "./datasets/OWC_test/OWC_train.jsonl"
train_df = pd.read_json(train_jsonl_path, lines=True)
train_ds = Dataset.from_pandas(train_df)
train_dataset = train_ds.map(process_func, remove_columns=train_ds.column_names)
test_jsonl_path = "./datasets/OWC_test/OWC_test.jsonl"
...
swanlab_callback = HuanhuanSwanLabCallback(
    project="Qwen2.5-LoRA-OWC",
    experiment_name="1.5b",
    config={
        "model": "https://modelscope.cn/models/Qwen/Qwen2.5-1.5B-Instruct",
